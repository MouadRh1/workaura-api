        ...
        <div class="content">
            ...
            <div class="details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value status-pending">⏳ En attente de confirmation</span>
                </div>
                
                @if($booking->notes)
                <div class="detail-row" style="flex-direction: column; align-items: stretch; gap: 5px;">
                    <span class="detail-label">Notes du client</span>
                    <span class="detail-value" style="font-weight: normal; font-size: 14px;">{{ $booking->notes }}</span>
                </div>
                @endif
            </div>
            ...
            <div style="text-align: center; display: flex; flex-direction: column; gap: 10px;">
                ...
                <p style="color: #A0A0B8; font-size: 12px; margin: 0;">
